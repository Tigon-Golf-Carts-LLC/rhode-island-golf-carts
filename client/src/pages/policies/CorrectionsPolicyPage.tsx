...
export default function CorrectionsPolicyPage() {
  return (
    <>
      <SEOHead 
        title="Corrections Policy | Pike County Golf Carts"
        description="Learn about Pike County Golf Carts' commitment to accuracy and our process for handling corrections to published content and information."
        keywords="corrections policy, content accuracy, Pike County golf carts, information corrections"
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="prose max-w-none">
              ...
              <p className="mb-6">
                Pike County Golf Carts is committed to providing accurate, up-to-date information across 
              ...
              <ul className="list-disc pl-6 mb-6">
                <li><strong>Email:</strong> info@pikecountygolfcarts.com with "Correction Request" in subject</li>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mb-2">Email: info@pikecountygolfcarts.com (Subject: Correction Request)</p>
