...
export default function PublishingPolicyPage() {
  return (
    <>
      <SEOHead 
        title="Publishing Policy | Pike County Golf Carts"
        description="Learn about Pike County Golf Carts' content publishing standards, guidelines for user-generated content, and editorial policies for our Pennsylvania website."
        keywords="publishing policy, content policy, Pike County golf carts, editorial guidelines"
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="prose max-w-none">
              ...
              <p className="mb-6">
                Pike County Golf Carts maintains high standards for all content published on our website, 
