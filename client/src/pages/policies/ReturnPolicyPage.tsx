      ...
      <section className="relative py-20 px-4 bg-gradient-to-r from-theme-primary to-blue-700 text-white bg-cover bg-center bg-no-repeat" style={getHeroBackgroundStyle("policy-return")}>
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Learn about our return policy for golf carts, parts, and accessories purchased from Rhode Island Golf Carts.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="prose max-w-none">
              ...
              <p className="mb-6">
                At Rhode Island Golf Carts, we strive for complete customer satisfaction. This return policy 
              ...
              <ul className="list-disc pl-6 mb-6">
                <li>Contact us at info@rhodeislandgolfcarts.com or 1-844-844-6638</li>
              ...
              <ul className="list-disc pl-6 mb-6">
                ...
                <li>Rhode Island Golf Carts not responsible for items lost in transit</li>
              </ul>
