...
export default function EthicsPolicyPage() {
  return (
    <>
      <SEOHead 
        title="Ethics Policy | Pike County Golf Carts"
        description="Learn about Pike County Golf Carts' code of ethics and business conduct standards for employees, customers, and partners in Pennsylvania."
        keywords="ethics policy, business ethics, Pike County golf carts, code of conduct Pennsylvania"
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="prose max-w-none">
              ...
              <p className="mb-6">
                Pike County Golf Carts operates with the highest standards of integrity, honesty, 
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="mb-2">Email: info@pikecountygolfcarts.com (Confidential Ethics Reports)</p>
