  ...
  return (
    <>
      <SEOHead 
        ...
        description="Rent premium electric golf carts throughout the City of Rhode Island, Virginia with daily, weekly, and monthly options, full insurance, and delivery service. Call 1-844-844-6638."
