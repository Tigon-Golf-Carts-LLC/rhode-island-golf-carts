...
export default function DenagoEvNomadXlPage() {
  return (
    <VehicleDetailPage
      ...
      seoTitle="DENAGO EV NOMAD XL - Extended Adventure Golf Cart | Rhode Island Golf Carts"
      seoDescription="Experience the DENAGO EV NOMAD XL electric golf cart in Atlantic County, PA. Extended range premium off-road package with enhanced cargo space."
      ...
      tigoUrl="https://rhodeislandgolfcarts.com/denago-ev/nomad-xl/"
    />
  );
}