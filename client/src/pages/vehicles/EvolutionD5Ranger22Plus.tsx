...
export default function EvolutionD5Ranger22Plus() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION® D5 RANGER 2+2 PLUS - Premium Electric Golf Cart | Rhode Island Golf Carts"
        description="Discover the EVOLUTION® D5 RANGER 2+2 PLUS - Ultimate in electric vehicle performance with advanced capabilities and premium features. Available at Rhode Island Golf Carts."
        keywords="EVOLUTION D5 RANGER 2+2 PLUS, electric golf cart, premium electric vehicle, EVOLUTION dealer Rhode Island"
      />
