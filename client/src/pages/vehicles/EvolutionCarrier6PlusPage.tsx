...
export default function EvolutionCarrier6PlusPage() {
  return (
    <VehicleDetailPage
      ...
      seoDescription="Discover the EVOLUTION CARRIER 6 PLUS electric golf cart in Rhode Island. 6-passenger utility vehicle with enhanced cargo capacity and work features."
      seoKeywords="EVOLUTION CARRIER 6 PLUS, utility golf cart, 6-passenger, cargo capacity, Rhode Island"
      ...
      description="6-passenger utility vehicle with enhanced cargo capacity and work features. The EVOLUTION CARRIER 6 PLUS is designed for both passenger transport and utility work in Rhode Island communities."
