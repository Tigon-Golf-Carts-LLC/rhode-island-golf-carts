...
export default function DenagoEvRoverXxlPage() {
  return (
    <VehicleDetailPage
      ...
      seoTitle="DENAGO EV ROVER XXL - Maximum Capacity Golf Cart | Rhode Island Golf Carts"
      ...
      canonicalUrl="https://rhodeislandgolfcarts.com/vehicles/denago-ev-rover-xxl"
      seats="8"
      range="60 miles"
      topSpeed="25 mph"
      driveType="2x4"
      ...
      tigoUrl="https://rhodeislandgolfcarts.com/denago-ev/rover-xxl/"
    />
  );
}