...
export default function EvolutionD6MaxXt4Page() {
  return (
    <VehicleDetailPage
      ...
      seoTitle="EVOLUTION D6 MAX XT4 - High-Performance Golf Cart | Rhode Island Golf Carts"
      ...
      canonicalUrl="https://rhodeislandgolfcarts.com/vehicles/evolution-d6-max-xt4"
      seats="4"
      range="50 miles"
      topSpeed="25 mph"
      ...
      tigoUrl="https://rhodeislandgolfcarts.com/evolution/d6-max/xt4/"
    />
  );
}