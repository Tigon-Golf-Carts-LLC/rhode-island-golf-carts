        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-100 mb-8 max-w-2xl mx-auto">
              Rent premium electric golf carts in {municipality.name} {municipality.type}, Rhode Island. 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Flexible rental options to meet your needs in {municipality.name} {municipality.type}, Rhode Island.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                Rhode Island. Our rental golf carts are street-legal, fully charged, and ready for immediate use.
              </p>
      ...
      <section className="py-16 px-4 bg-theme-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-100 mb-8">
            Contact Rhode Island Golf Carts today to reserve your rental golf cart 
